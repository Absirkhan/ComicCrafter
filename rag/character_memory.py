...
class CharacterMemory:
    ...
    def get_character(self, character_name: str) -> Optional[Character]:
        ...
        try:
            results = self.vector_store.get_by_id([character_id])
    ...
    def get_character_context(
        ...
        # Build context focused on visual consistency
        context_parts = [character.appearance]
        ...
        if scene_description:
            ...
            if relevant_chars and relevant_chars[0].name == character_name:
                if relevant_chars[0].personality:
                    context_parts.append(f"with {relevant_chars[0].personality} expression")
